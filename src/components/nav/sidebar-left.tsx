  ...
  return (
    <aside className="custom-scrollbar sticky left-0 top-0 flex flex-col justify-between overflow-hidden overflow-y-auto border-r border-customLight-800 bg-customLight-900 p-6 pt-36 shadow-customDark-300  dark:border-customDark-300 dark:bg-customDark-200 dark:shadow-none max-sm:hidden lg:w-[266px]">
      ...
      {session ? (
        ...
        <Link
          href="/signin"
          className="flex w-full items-center justify-center gap-2 rounded-lg border-customLight-700 bg-customLight-700 p-4 text-[14px] font-semibold leading-[15.6px] tracking-wide text-customDark-400 shadow-none hover:opacity-50 dark:border-customDark-400 dark:bg-customDark-300 dark:text-customLight-900 lg:py-5"
        >
          <Icons.login
